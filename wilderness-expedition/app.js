...
(function () {
  ...
  function sharedTourTotals(f) {
    ...
    var adults = Math.max(1, Number(f.adults || 0));
    ...
    var sharedTourForm2 = pkg === "sharedTour" && h(
      ...
      h(
        ...
        h(
          ...
          h(Stepper, { value: sharedTourForm.adults, min: 1, onChange: function (v) { setSharedTourForm(Object.assign({}, sharedTourForm, { adults: v })); } })
        )
      ),
      h(
